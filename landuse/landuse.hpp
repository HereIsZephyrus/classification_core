...
bool FindBestClassifier(std::shared_ptr<Classified> classified,const vector<std::unique_ptr<T_Classifier<LandCover>>>& classifiers,const vector<cv::Mat>& classifiedImages);
